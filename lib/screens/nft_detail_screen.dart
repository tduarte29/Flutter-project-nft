      ...
      body: Column(
        ...
        children: <Widget>[
          Stack(
            children: [
              Container(
                height: 380.0, // Ajuste a altura conforme necessário
                decoration: const BoxDecoration(
                  borderRadius: BorderRadius.vertical(bottom: Radius.circular(20.0)),
                  image: DecorationImage(
                    image: AssetImage('assets/images/mosu_1930.png'), // Substitua pela sua imagem
                    fit: BoxFit.cover,
                  ),
                ),
              ),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: const BoxDecoration(
                            shape: BoxShape.circle,
                            image: DecorationImage(
                              image: AssetImage('assets/images/creator_profile.png'), // Substitua pela sua imagem
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: const BoxDecoration(
                            shape: BoxShape.circle,
                            image: DecorationImage(
                              image: AssetImage('assets/images/owner_profile.png'), // Substitua pela sua imagem
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                  ...
                  children: [
                    Column(
                      ...
                      children: const [
                        ...
                        Row(
                          children: [
                            Icon(Icons.diamond_outlined, color: Colors.white, size: 16.0),
                            SizedBox(width: 4.0),
                            Text(
                              '2,74 ETH',
                              style: TextStyle(
